                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex space-x-4">
                        <p className="text-sm lg:text-lg flex items-center gap-1 font-header text-semibold">
                            Made With <Heart className="text-red-700" size={18} fill="currentColor" /> by Kanupriya Agarwal
                        </p>
                        <a href="https://github.com/kanu123-prog" target="_blank" className="text-accent hover:text-highlight transition-colors duration-200">
                            <Github size={22} />
                        </a>
                        <a href="https://www.linkedin.com/in/kanupriya1411/" target="_blank" className="text-accent hover:text-highlight transition-colors duration-200">
                            <Linkedin size={22} />
                        </a>
                    </div>
                </div>
